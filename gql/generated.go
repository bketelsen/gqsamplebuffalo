...
func (ec *executionContext) _Query_posts(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalOPost2ᚕᚖgithubᚗcomᚋbketelsenᚋgqsamplebuffaloᚋgqlᚐPost(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOPost2githubᚗcomᚋbketelsenᚋgqsamplebuffaloᚋgqlᚐPost(ctx context.Context, sel ast.SelectionSet, v Post) graphql.Marshaler {
	return ec._Post(ctx, sel, &v)
}

func (ec *executionContext) marshalOPost2ᚕᚖgithubᚗcomᚋbketelsenᚋgqsamplebuffaloᚋgqlᚐPost(ctx context.Context, sel ast.SelectionSet, v []*Post) graphql.Marshaler {
	ret := make(graphql.Array, len(v))
	var wg sync.WaitGroup
	isLen1 := len(v) == 1
	if !isLen1 {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOPost2ᚖgithubᚗcomᚋbketelsenᚋgqsamplebuffaloᚋgqlᚐPost(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOPost2ᚖgithubᚗcomᚋbketelsenᚋgqsamplebuffaloᚋgqlᚐPost(ctx context.Context, sel ast.SelectionSet, v *Post) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Post(ctx, sel, v)
